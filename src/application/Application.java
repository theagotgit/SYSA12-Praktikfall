...
public class Application {
	...
	private void initialize() {
		...
		datePickerReceived.getJFormattedTextField().setBackground(Color.WHITE);
		...
		datePickerPrinted.getJFormattedTextField().setBackground(Color.WHITE);
		...
		datePickerExpiryDate.getJFormattedTextField().setBackground(Color.WHITE);
